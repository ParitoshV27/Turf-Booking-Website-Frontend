...
const bookprices = document.querySelector('.bookprices');
const inputDate = document.querySelector('.date');
const inputTime = document.querySelector('.timeslot');
const inputPhone = document.querySelector('.phonenumber');
const modalText = document.querySelector('.modaltext');



bookprices.addEventListener('click', function(e){
...
confirm.addEventListener('click', function(e){
    if(inputTime.value && inputDate.value && inputPhone.value){
    openModal.classList.remove("hidemodal");
    modalText.textContent = `Yay!!🥳 your booking on ${inputDate.value} at ${inputTime.value} is confirmed👍
    Check SMS on ${inputPhone.value}`;
    };
...
document.addEventListener('keydown', function(e){
    ...
    if(e.key === 'Escape' && !openModal.classList.contains("hidemodal")){
        openModal.classList.add("hidemodal");
